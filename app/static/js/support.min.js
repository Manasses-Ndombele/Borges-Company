function handleBaseSections(entries){entries.forEach(entry=>{if(entry.isIntersecting&&entry.target.classList.contains('animated')==!1){entry.target.classList.add('appear-diag-enter')
...
let contactsArea=document.querySelector('div#contacts-area')
let socialLinks=document.querySelector('div.social-links')
let supportArea=document.querySelector('div#support-area')
let baseTargets=[contactsArea,socialLinks,supportArea]
